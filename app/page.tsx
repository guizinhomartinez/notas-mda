...
export default function Home() {
    return (
        <div className="from-background flex h-screen max-h-screen w-screen flex-col items-center justify-center gap-24 bg-gradient-to-b to-zinc-400/5 p-8 font-sans">
